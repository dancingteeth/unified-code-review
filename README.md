...
| **1. Risk** | Blast radius first (auth, payments, migrations ≠ copy tweaks); failure modes, reversibility, verification gap. What to read line-by-line, empirical checks. |
