...
| **Hot path raises risk**; **`[parallel_path]`** (follow prior art / wrong system); **`[unproven_removal]`** (production-caller signal before trusting a deletion) | [Sean Goedecke — Mistakes engineers make in large established codebases](https://www.seangoedecke.com/large-established-codebases/) |
| **`[unearned_defense]`** (ignorance and paranoia); second-model agreement is not familiarity; overlay accepted-risk / standard-home laws | [Sean Goedecke — You have to beat the models at something](https://www.seangoedecke.com/you-have-to-beat-the-models-at-something/) |
